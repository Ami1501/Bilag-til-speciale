...
options(scipen=999)
plot(ts(Sammenligning[,2], start=c(1929,4), end=2021, frequency = 12), type='l',lwd=1,col="green",log="y",yaxt = "n",xlab="Tid",ylab="Formue");axis(2, c(1,10,100,1000,10000,100000),las=1)
...
xx <- barplot(t(PogBABAlpha),beside=T, #main="Jensens alfa fordelt ud på P1 - P10",
              ylab="CAPM alfa",xlab="Porteføljer",col=c("grey80","grey40"),names.arg=c("P1", "P2", "P3", "P4", "P5", "P6", "P7", "P8", "P9", "P10","BAB"),ylim=c(-0.1,0.8),las=1)
